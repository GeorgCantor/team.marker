 ...
 */
class ScannerSourceData(
    /** Raw YUV data  */
    val data: ByteArray,
    /** Source data width  */
    var dataWidth: Int, dataHeight: Int, imageFormat: Int, rotation: Int
) {
    /**
     *
    ...
    fun createSource(): ScannerPlanarYUVLuminanceSource {
        val rotated = rotateCameraPreview(
            rotation,
        ...
        return if (isRotated) {
            ScannerPlanarYUVLuminanceSource(
                rotated,
                dataHeight,
                dataWidth,
                cropRect!!.left,
