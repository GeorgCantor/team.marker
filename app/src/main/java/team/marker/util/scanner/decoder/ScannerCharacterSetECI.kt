 ...
 * @author Sean Owen
 */
enum class ScannerCharacterSetECI {
    ...
    companion object {
        private val VALUE_TO_ECI: MutableMap<Int, ScannerCharacterSetECI> = HashMap()
        private val NAME_TO_ECI: MutableMap<String, ScannerCharacterSetECI> = HashMap()

        @Throws(ScannerFormatException::class)
        fun getCharacterSetECIByValue(value: Int): ScannerCharacterSetECI? {
         ...
         * but unsupported
         */
        fun getCharacterSetECIByName(name: String): ScannerCharacterSetECI? {
