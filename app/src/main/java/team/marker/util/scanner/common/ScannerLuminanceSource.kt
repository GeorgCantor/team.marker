 ...
 */
abstract class ScannerLuminanceSource protected constructor(
    /**
     ...
     */
    open fun crop(left: Int, top: Int, width: Int, height: Int): ScannerLuminanceSource? {
     ...
     */
    open fun invert(): ScannerLuminanceSource? {
        return ScannerInvertedLuminanceSource(this)
    }
     ...
     */
    open fun rotateCounterClockwise(): ScannerLuminanceSource? {
     ...
     * @return A rotated version of this object.
     */
    open fun rotateCounterClockwise45(): ScannerLuminanceSource? {
    ...
    override fun toString(): String {
        ...
        for (y in 0 until height) {
            ...
            for (x in 0 until width) {
                val luminance: Int = row[x] and 0xFF
                var c: Char
                c = if (luminance < 0x40) {
                    '#'
