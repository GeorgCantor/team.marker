package team.marker.view.demo.product
...
import team.marker.view.product.ProductFilesAdapter
import team.marker.view.product.ProductOptionsAdapter
import team.marker.view.product.ProductViewModel

class DemoProductFragment : Fragment(R.layout.fragment_product) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.error.observe(viewLifecycleOwner, {
            findNavController().navigate(R.id.action_demoProductFragment_to_scanErrorFragment)
        })
